...
| `/docs-kit:docs-render` | Generate/refresh the HTML views of `docs/` — `index.html` (menu beside README), `current.html` (Layer 1), `changes.html` (Layer 2 + audit). Deterministic script, never edits markdown. |
